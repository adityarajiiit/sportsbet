...
export const LoaderThree = () => {
  return (
    <motion.svg
      ...
      className="h-20 w-20 stroke-neutral-100 [--fill-final:var(--color-yellow-300)] [--fill-initial:var(--color-warning)]">
...
export const LoaderFour = ({
  ...
  return (
    <div
      className="relative font-bold text-white [perspective:1000px] dark:text-white">
      <motion.span
        animate={{
          skew: [0, -40, 0],
          scaleX: [1, 2, 1],
