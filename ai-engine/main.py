...
app.include_router(insights.router,prefix="/api",tags=["Match Insights"])
app.include_router(betAdvisor.router,prefix="/api",tags=["Bet Advisor"])
app.include_router(stockPredict.router,prefix="/api",tags=["Stock Predictor"])
app.include_router(alerts.router,prefix="/api",tags=["Smart Alerts"])
