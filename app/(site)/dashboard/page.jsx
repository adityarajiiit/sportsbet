...
const dashboard = () => {
  ...
  return (
    <div className="pt-20 p-4" data-theme={theme}>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-4">
          <div
            className="p-1.5 px-3 rounded-xl flex items-center justify-between bg-[rgba(248,248,248,0.01)]
    ...
    shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)]"
            ...
            <button
              ...
              onClick={() => document.getElementById("Add_balance").showModal()}
            >
              Add Money
            </button>
              ...
              <div className="modal-box">
                ...
                <div className=" mt-2 bg-base-300 rounded-lg p-2">
                  <div className="bg-base-100 border-base-300 p-6">
                    ...
                    <p className="text-xs font-poppins">minimum amount : ₹30</p>
